...
def applyleave(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            no_of_days=(date-start_date)
            total_days_applied=(end_date-start_date)
            if leave_type=='Paid_Leave' and no_of_days.days>=14 and total_days_applied.days<=2:
